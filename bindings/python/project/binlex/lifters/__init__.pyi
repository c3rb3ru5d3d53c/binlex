...
class Lifter:
    ...
    def __init__(self, cpu: LirCpu, configuration: Configuration, backend: LifterBackend = LifterBackend.DEFAULT, triple: str | None = None) -> None: ...
    ...
    def create_function(self, name: str, abi: LirAbi | None = None) -> llvm.LiftedFunction: ...
