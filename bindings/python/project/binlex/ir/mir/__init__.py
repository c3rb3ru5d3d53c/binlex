...
class Mir:
    ...
    def from_dict(cls, data):
        return cls._from_inner(_MirBinding.from_dict(data))

    @classmethod
    def from_lir(cls, lir_module, name=None):
        lir_module = getattr(lir_module, "_inner", lir_module)
        return cls._from_inner(_MirBinding.from_lir(lir_module, name=name))
