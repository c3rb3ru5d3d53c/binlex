...
class SemanticExpression:
    ...
    def binary_operation(self) -> SemanticOperationBinary | None: ...
    def unary_operation(self) -> SemanticOperationUnary | None: ...
    def cast_operation(self) -> SemanticOperationCast | None: ...
    def compare_operation(self) -> SemanticOperationCompare | None: ...
    def to_dict(self) -> Any: ...
    def json(self) -> str: ...
    def print(self) -> None: ...
