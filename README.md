# BinLex a Genetic Binary Trait Library and Tool
...
Most projects attempting this us only Python. When working with a lot of malware binaries, it is much better to use a faster compiled language like C++.
