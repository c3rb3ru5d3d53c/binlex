use crate::irs::mir::{Mir, MirOperation, MirOperationKind, MirTerminator, MirValue};
...
fn zero_like(value: &MirValue, fallback_ty: &crate::irs::mir::MirType) -> MirValue {
    match value {
...
trait FallbackValue {
    fn or_fallback(self, fallback_ty: &crate::irs::mir::MirType) -> MirValue;
}

impl FallbackValue for MirValue {
    fn or_fallback(self, _fallback_ty: &crate::irs::mir::MirType) -> MirValue {
        self
    }
}
