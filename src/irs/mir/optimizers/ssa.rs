use crate::irs::mir::analysis::{mir_predecessors, mir_successors, reverse_post_order};
use crate::irs::mir::{
...
fn block_use_def(block: &crate::irs::mir::MirBlock) -> (HashSet<String>, HashSet<String>) {
