use crate::irs::lir::{LirAbi, LirCpuKind};
use crate::irs::mir::{Mir, MirAddressSpace, MirCallClobber, MirOperationKind, MirType, MirValue};
...
fn matches_register_role_location(
    location: &crate::irs::lir::LirLocation,
    raw_name: &str,
    cpu: &crate::irs::lir::LirCpu,
) -> bool {
    let crate::irs::lir::LirLocation::Register { name, .. } = location else {
        return false;
    };
    match (
...
fn canonical_register_storage_name(cpu: &crate::irs::lir::LirCpu, name: &str) -> Option<String> {
