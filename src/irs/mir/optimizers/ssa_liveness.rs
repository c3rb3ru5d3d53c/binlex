use crate::irs::mir::analysis::{build_use_counts, mir_predecessors};
use crate::irs::mir::{Mir, MirControlTarget, MirTerminator, MirValue};
...
fn replace_block_uses(block: &mut crate::irs::mir::MirBlock, name: &str, replacement: &MirValue) {
...
fn replace_operation_uses(
    ...
    use crate::irs::mir::MirOperationKind;
...
mod tests {
    use super::*;
    use crate::irs::mir::{MirBlock, MirBlockParameter, MirOperation, MirOperationKind, MirType};
