...
const XMM1: u128 = u128::from_le_bytes([
    0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x80, 0xcc, 0xed, 0x34, 0xf2,
]);
...
#[test]
fn pabsd_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pabsd_lir_match_unicorn_transitions() {
