...
pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        mnemonic: "psrldq",
        instruction: "psrldq xmm0, 1",
        architecture: Architecture::AMD64,
        bytes: &[0x66, 0x0f, 0x73, 0xd8, 0x01],
    ...
    X86Sample {
        mnemonic: "psrldq",
        instruction: "vpsrldq xmm0, xmm1, 1",
        architecture: Architecture::AMD64,
        bytes: &[0xc5, 0xf9, 0x73, 0xd9, 0x01],
        expected_status: Some(LirStatus::Complete),
        lir_fixture: None,
        roundtrip_fixture: None,
    },
    ...
    X86Sample {
        mnemonic: "psrldq",
        instruction: "psrldq xmm0, 4",
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x73, 0xd8, 0x04],
        expected_status: None,
        lir_fixture: None,
...
#[test]
fn psrldq_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn psrldq_lir_match_unicorn_transitions() {
    assert_conformance_cases(SAMPLES);
}

#[test]
fn psrldq_roundtrip_matches_unicorn() {
