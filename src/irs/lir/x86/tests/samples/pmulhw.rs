...
pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        mnemonic: "pmulhw",
        instruction: "pmulhw xmm0, xmm1",
        architecture: Architecture::AMD64,
        bytes: &[0x66, 0x0f, 0xe5, 0xc1],
    ...
    X86Sample {
        mnemonic: "pmulhw",
        instruction: "vpmulhw xmm0, xmm2, xmm1",
        architecture: Architecture::AMD64,
        bytes: &[0xc5, 0xe9, 0xe5, 0xc1],
        expected_status: Some(LirStatus::Complete),
        lir_fixture: None,
        roundtrip_fixture: None,
    },
...
#[test]
fn pmulhw_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pmulhw_lir_match_unicorn_transitions() {
