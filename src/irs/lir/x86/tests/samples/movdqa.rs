...
pub(crate) const SAMPLES: &[X86Sample] = &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x6f, 0x43, 0x04],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x7f, 0x43, 0x04],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x7f, 0x45, 0xf0],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x6f, 0x45, 0xf0],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x7f, 0x44, 0x24, 0x10],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x6f, 0x44, 0x24, 0x10],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x7f, 0x43, 0x10],
        expected_status: None,
        lir_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
...
#[test]
fn movdqa_lir_regressions_stay_complete() {
