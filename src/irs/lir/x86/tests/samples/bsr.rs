...
pub(crate) const SAMPLES: &[X86Sample] = &[X86Sample {
    mnemonic: "bsr",
    instruction: "bsr ecx, eax",
    architecture: Architecture::I386,
    bytes: &[0x0f, 0xbd, 0xc8],
...
#[test]
fn bsr_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn bsr_lir_match_unicorn_transitions() {
    assert_conformance_cases(SAMPLES);
}

#[test]
fn bsr_roundtrip_i386_matches_unicorn() {
    assert_i386_instruction_roundtrip_match_unicorn(
        "bsr ecx, eax",
        &[0x0f, 0xbd, 0xc8],
        I386Fixture {
...
#[test]
fn bsr_roundtrip_i386_zero_matches_unicorn() {
    assert_i386_instruction_roundtrip_match_unicorn(
        "bsr ecx, eax",
        &[0x0f, 0xbd, 0xc8],
        I386Fixture {
...
#[test]
fn bsr_roundtrip_amd64_matches_unicorn() {
