    ...
    X86Sample {
        ...
        lir_fixture: Some(X86FixtureSpec {
            ...
            memory: &[(
                0x2800,
                &[
                    0x77, 0x77, 0x77, 0x77, 0x66, 0x66, 0x66, 0x66, 0x55, 0x55, 0x55, 0x55, 0x40,
                    0x28, 0x00, 0x00, 0x44, 0x44, 0x44, 0x44, 0x33, 0x33, 0x33, 0x33, 0x22, 0x22,
                    0x22, 0x22, 0x11, 0x11, 0x11, 0x11,
                ],
            )],
        }),
        roundtrip_fixture: None,
...
#[test]
fn pop_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pop_lir_match_unicorn_transitions() {
