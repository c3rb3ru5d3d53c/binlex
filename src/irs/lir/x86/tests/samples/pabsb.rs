...
const XMM1_BYTES: [u8; 16] = [
    0x01, 0xff, 0x80, 0xfe, 0x7f, 0x81, 0x04, 0xfc, 0x55, 0x44, 0x33, 0xdd, 0xee, 0x00, 0x99, 0x88,
];
...
#[test]
fn pabsb_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pabsb_lir_match_unicorn_transitions() {
