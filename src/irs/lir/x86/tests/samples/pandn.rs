...
pub(crate) const SAMPLES: &[X86Sample] = &[
    ...
    X86Sample {
        mnemonic: "pandn",
        instruction: "vpandn xmm0, xmm2, xmm1",
        architecture: Architecture::AMD64,
        bytes: &[0xc5, 0xe9, 0xdf, 0xc1],
        expected_status: Some(LirStatus::Complete),
        lir_fixture: None,
        roundtrip_fixture: None,
    },
...
#[test]
fn pandn_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pandn_lir_match_unicorn_transitions() {
