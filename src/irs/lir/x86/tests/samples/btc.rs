...
pub(crate) const SAMPLES: &[X86Sample] = &[X86Sample {
    mnemonic: "btc",
    instruction: "btc eax, 1",
    architecture: Architecture::I386,
    bytes: &[0x0f, 0xba, 0xf8, 0x01],
...
#[test]
fn btc_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn btc_lir_match_unicorn_transitions() {
    assert_conformance_cases(SAMPLES);
}

#[test]
fn btc_roundtrip_i386_matches_unicorn() {
