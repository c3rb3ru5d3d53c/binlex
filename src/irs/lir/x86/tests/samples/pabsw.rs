...
const XMM1: u128 = u128::from_le_bytes([
    0x01, 0x00, 0xff, 0xff, 0x00, 0x80, 0xfe, 0xff, 0x34, 0x12, 0xcc, 0xed, 0x78, 0x56, 0xaa, 0xff,
]);
...
#[test]
fn pabsw_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pabsw_lir_match_unicorn_transitions() {
