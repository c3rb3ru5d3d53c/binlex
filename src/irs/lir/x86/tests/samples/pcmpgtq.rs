...
const XMM0_BYTES: [u8; 16] = [
    0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11, 0xf8, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
];
const XMM1_BYTES: [u8; 16] = [
    0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
];
const XMM2_BYTES: [u8; 16] = [
    0x80, 0x70, 0x60, 0x50, 0x40, 0x30, 0x20, 0x10, 0xfe, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
];
...
#[test]
fn pcmpgtq_lir_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn pcmpgtq_lir_match_unicorn_transitions() {
