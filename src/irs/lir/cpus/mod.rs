...
pub struct LirCpuI386;

impl LirCpuI386 {
    pub fn new() -> Result<LirCpu, LirExecutorError> {
        LirCpu::from_kind(LirCpuKind::I386)
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct LirCpuAmd64;

impl LirCpuAmd64 {
    pub fn new() -> Result<LirCpu, LirExecutorError> {
        LirCpu::from_kind(LirCpuKind::Amd64)
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct LirCpuArm64;

impl LirCpuArm64 {
    pub fn new() -> Result<LirCpu, LirExecutorError> {
        LirCpu::from_kind(LirCpuKind::Arm64)
    }
}

#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct LirCpuCil;

impl LirCpuCil {
    pub fn new() -> Result<LirCpu, LirExecutorError> {
        LirCpu::from_kind(LirCpuKind::Cil)
    }
}
