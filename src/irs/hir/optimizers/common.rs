use crate::irs::hir::{HirExpression, HirFunction, HirPlace, HirTarget, HirType};
...
pub(crate) fn zero_expression_for_type(ty: &HirType) -> HirExpression {
    match ty {
        HirType::Integer(bits) => HirExpression::Value(crate::irs::hir::HirValue::Integer {
            value: 0,
            bits: *bits,
        }),
        _ => HirExpression::Value(crate::irs::hir::HirValue::Integer { value: 0, bits: 64 }),
    }
}
