...
use crate::formats::{Image, ImageContext};
use crate::irs::hir::{
...
impl Eq for AstFunction {}

impl Hash for AstFunction {
...
impl AstFunction {
    ...
    pub fn set_image(&mut self, image: &Image) {
        self.image = Some(ImageContext::from_image(image));
    }
...
fn type_bits(ty: &crate::irs::hir::HirType) -> u16 {
    match ty {
        crate::irs::hir::HirType::Integer(bits) | crate::irs::hir::HirType::Float(bits) => *bits,
        crate::irs::hir::HirType::Pointer { .. } => 64,
        _ => 0,
    }
}
...
mod tests {
    use super::*;
    use crate::irs::hir::{HirBlock, HirType};
