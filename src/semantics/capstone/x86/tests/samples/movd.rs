...
fn roundtrip_samples() -> Vec<X86RuntimeSample> {
    let mut samples = Vec::new();
    {
        samples.push(X86RuntimeSample {
            ...
            bytes: (&[0x66, 0x0f, 0x7e, 0xc0]).to_vec(),
    ...
    }
    {
        samples.push(X86RuntimeSample {
            ...
            architecture: Architecture::I386,
            bytes: (&[0x66, 0x0f, 0x6e, 0xc0]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            ...
            architecture: Architecture::I386,
            bytes: (&[0x66, 0x0f, 0x6e, 0x43, 0x04]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            ...
            architecture: Architecture::I386,
            bytes: (&[0x66, 0x0f, 0x7e, 0x43, 0x04]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            ...
            architecture: Architecture::I386,
            bytes: (&[0x66, 0x0f, 0x6e, 0x45, 0xfc]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            ...
            architecture: Architecture::I386,
            bytes: (&[0x66, 0x0f, 0x7e, 0x45, 0xfc]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
