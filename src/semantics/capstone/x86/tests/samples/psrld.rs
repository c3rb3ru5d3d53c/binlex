...
pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        mnemonic: "psrld",
        instruction: "psrld xmm0, 1",
        architecture: Architecture::AMD64,
        bytes: &[0x66, 0x0f, 0x72, 0xd0, 0x01],
    ...
    X86Sample {
        mnemonic: "psrld",
        instruction: "psrld xmm0, 4",
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0x72, 0xd0, 0x04],
...
#[test]
fn psrld_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn psrld_roundtrip_matches_unicorn() {
