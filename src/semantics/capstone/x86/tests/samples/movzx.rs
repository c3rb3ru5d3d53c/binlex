...
fn roundtrip_samples() -> Vec<X86RuntimeSample> {
    ...
    }
    {
        samples.push(X86RuntimeSample {
            mnemonic: "movzx",
            instruction: "movzx eax, byte ptr [ebx+4]",
            architecture: Architecture::I386,
            bytes: (&[0x0f, 0xb6, 0x43, 0x04]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            mnemonic: "movzx",
            instruction: "movzx eax, word ptr [ebx+4]",
            architecture: Architecture::I386,
            bytes: (&[0x0f, 0xb7, 0x43, 0x04]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            mnemonic: "movzx",
            instruction: "movzx eax, byte ptr [esp+4]",
            architecture: Architecture::I386,
            bytes: (&[0x0f, 0xb6, 0x44, 0x24, 0x04]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
    ...
    }
    {
        samples.push(X86RuntimeSample {
            mnemonic: "movzx",
            instruction: "movzx eax, byte ptr [ebp-4]",
            architecture: Architecture::I386,
            bytes: (&[0x0f, 0xb6, 0x45, 0xfc]).to_vec(),
            expected_status: None,
            semantics_fixture: None,
            roundtrip_fixture: Some(X86RuntimeFixtureSpec {
                registers: vec![
...
#[test]
fn movzx_roundtrip_matches_unicorn() {
