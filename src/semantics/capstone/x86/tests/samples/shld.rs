...
pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        mnemonic: "shld",
        instruction: "shld eax, edx, cl",
        architecture: Architecture::I386,
        bytes: &[0x0f, 0xa5, 0xd0],
    ...
    X86Sample {
        mnemonic: "shld",
        instruction: "shld eax, edx, 4",
        architecture: Architecture::I386,
        bytes: &[0x0f, 0xa4, 0xd0, 0x04],
...
#[test]
fn shld_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn shld_roundtrip_matches_unicorn() {
