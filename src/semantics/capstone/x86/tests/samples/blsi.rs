...
pub(crate) const SAMPLES: &[X86Sample] = &[X86Sample {
    mnemonic: "blsi",
    instruction: "blsi eax, ecx",
    architecture: Architecture::AMD64,
    bytes: &[0xc4, 0xe2, 0x78, 0xf3, 0xd9],
    expected_status: Some(SemanticStatus::Complete),
    semantics_fixture: Some(X86FixtureSpec {
        registers: &[(I386Register::Eax, 0), (I386Register::Ecx, 0b1011000)],
        eflags: 1 << 1,
        memory: &[],
    }),
...
#[test]
fn blsi_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn blsi_semantics_match_unicorn_transitions() {
    assert_conformance_cases(SAMPLES);
}

#[test]
fn blsi_roundtrip_amd64_matches_unicorn() {
