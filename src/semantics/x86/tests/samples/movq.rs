...
pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        ...
        bytes: &[0x66, 0x0f, 0xd6, 0x45, 0xf8],
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0xf3, 0x0f, 0x7e, 0x43, 0x04],
        expected_status: None,
        semantics_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0xd6, 0x43, 0x04],
        expected_status: None,
        semantics_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
    ...
    X86Sample {
        ...
        architecture: Architecture::I386,
        bytes: &[0xf3, 0x0f, 0x7e, 0x44, 0x24, 0x04],
        expected_status: None,
        semantics_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
            ...
            eflags: 0x202,
            memory: &[(0x2ff4, &[0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11])],
        }),
    },
    X86Sample {
        mnemonic: "movq",
        ...
        architecture: Architecture::I386,
        bytes: &[0x66, 0x0f, 0xd6, 0x44, 0x24, 0x04],
        expected_status: None,
        semantics_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
            ...
            eflags: 0x202,
            memory: &[(0x2ff4, &[0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x00, 0x11])],
        }),
    },
    X86Sample {
        mnemonic: "movq",
        ...
        architecture: Architecture::I386,
        bytes: &[0xf3, 0x0f, 0x7e, 0x45, 0xf8],
        expected_status: None,
        semantics_fixture: None,
        roundtrip_fixture: Some(X86FixtureSpec {
            registers: &[
            ...
            eflags: 0x202,
            memory: &[(0x2fe8, &[0x88, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11])],
        }),
    },
];
