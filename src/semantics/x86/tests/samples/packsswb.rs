...
const XMM1: u128 = u128::from_le_bytes([
    0x01, 0xff, 0x02, 0xfe, 0x03, 0xfd, 0x04, 0xfc, 0x55, 0x44, 0x33, 0x22, 0x11, 0x00, 0x99, 0x88,
]);

pub(crate) const SAMPLES: &[X86Sample] = &[
    X86Sample {
        mnemonic: "packsswb",
        instruction: "packsswb xmm0, xmm1",
        architecture: Architecture::AMD64,
        bytes: &[0x66, 0x0f, 0x63, 0xc1],
    ...
    X86Sample {
        mnemonic: "packsswb",
        instruction: "vpacksswb xmm0, xmm2, xmm1",
        architecture: Architecture::AMD64,
        bytes: &[0xc5, 0xe9, 0x63, 0xc1],
        expected_status: Some(SemanticStatus::Complete),
        semantics_fixture: None,
        roundtrip_fixture: None,
    },
...
#[test]
fn packsswb_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn packsswb_semantics_match_unicorn_transitions() {
