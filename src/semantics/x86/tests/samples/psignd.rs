...
const XMM1: u128 = u128::from_le_bytes([
    0x01, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xcc, 0xed, 0x34, 0xf2,
]);

pub(crate) const SAMPLES: &[X86Sample] = &[X86Sample {
    mnemonic: "psignd",
    instruction: "psignd xmm0, xmm1",
    architecture: Architecture::AMD64,
    bytes: &[0x66, 0x0f, 0x38, 0x0a, 0xc1],
...
#[test]
fn psignd_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn psignd_semantics_match_unicorn_transitions() {
