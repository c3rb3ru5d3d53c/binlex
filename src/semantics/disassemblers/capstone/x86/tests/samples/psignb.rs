...
const XMM1_BYTES: [u8; 16] = [
    0x01, 0xff, 0x00, 0xfe, 0x03, 0x00, 0x04, 0x80, 0x55, 0x44, 0x33, 0x22, 0x00, 0xff, 0x99, 0x88,
];

pub(crate) const SAMPLES: &[X86Sample] = &[X86Sample {
    mnemonic: "psignb",
    instruction: "psignb xmm0, xmm1",
    architecture: Architecture::AMD64,
    bytes: &[0x66, 0x0f, 0x38, 0x08, 0xc1],
...
#[test]
fn psignb_semantics_regressions_stay_complete() {
    assert_sample_statuses(SAMPLES);
}

#[test]
fn psignb_semantics_match_unicorn_transitions() {
