...
impl LirAbi {
    ...
    pub fn supports_architecture(&self, architecture: Architecture) -> bool {
        matches!(
            ...
            (Some(crate::ir::lir::LirCpuKind::I386), Architecture::I386)
                | (Some(crate::ir::lir::LirCpuKind::Amd64), Architecture::AMD64)
                | (Some(crate::ir::lir::LirCpuKind::Arm64), Architecture::ARM64)
                | (Some(crate::ir::lir::LirCpuKind::Cil), Architecture::CIL)
        )
    }
