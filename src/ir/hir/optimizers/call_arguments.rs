use crate::ir::hir::optimizers::common::{next_generated_local_index, value_type};
use crate::ir::hir::{HirExpression, HirFunction, HirModule, HirPlace, HirStatement, HirTarget};
...
fn extract_complex_call_arguments_in_block(
    block: &mut crate::ir::hir::HirBlock,
    locals: &mut Vec<crate::ir::hir::statement::HirLocal>,
            ...
            for argument in arguments {
                if should_extract_complex_load_argument(argument) {
                    ...
                    *next_index += 1;
                    ...
                    locals.push(crate::ir::hir::statement::HirLocal {
                        name: name.clone(),
                        ty: ty.clone(),
                        init: None,
                    });
                    ...
                    *argument = HirExpression::Value(crate::ir::hir::HirValue::Named { name, ty });
                } else {
