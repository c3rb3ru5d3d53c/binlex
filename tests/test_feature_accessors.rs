...
#[test]
fn file_direct_accessors_compute_features() {
...
#[test]
fn chromosome_direct_accessors_compute_features() {
    let config = Configuration::default();
...
#[test]
fn imaging_direct_accessors_compute_hashes() {
    let config = Configuration::default();
...
#[test]
fn function_markov_direct_accessor_returns_normalized_scores() {
    let config = Configuration::default();
